...
int main()
{
	...
	double callP_StratifiedSampling = PriceClass::calculateP_StratifiedSampling(lookbackCall, S, r, sigma, T, 1000, 10);
	double putP_StratifiedSampling = PriceClass::calculateP_StratifiedSampling(lookbackPut, S, r, sigma, T, 1000, 10);
